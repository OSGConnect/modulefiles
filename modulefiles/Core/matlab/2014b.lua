...
The MCR is freely distributable as described by the license file located at:
  /cvmfs/oasis.opensciencegrid.org/osg/modules/matlab/2014b/MCR_license.txt

]])

local version = "2014b"
local base = "/cvmfs/oasis.opensciencegrid.org/osg/modules/matlab/2014b/v84"
