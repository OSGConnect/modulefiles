help(
[[
This module loads PAX 4.5.0 reconstruction code into the environment. 
...
prepend_path("PATH", "/cvmfs/oasis.opensciencegrid.org/osg/modules/anaconda/pax-4.5.0/envs/pax/bin")
setenv("ROOTSYS", "")
